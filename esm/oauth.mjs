...
import _sessionStoreJs from "./sessionStore.mjs";
import _atprotoOauthClientNode from "@atproto/oauth-client-node";
import _atprotoJwkJose from "@atproto/jwk-jose";
var module = {
  exports: {}
};
...
var _require = _atprotoJwkJose,
  JoseKey = _require.JoseKey;
var _require2 = _atprotoOauthClientNode,
  NodeOAuthClient = _require2.NodeOAuthClient;
var _require3 = _sessionStoreJs,
  InMemoryStore = _require3.InMemoryStore;
var client = null;
var stateStore = null;
...
function getConfig() {
  ...
  var metadata = {
    ...
    redirect_uris: config.redirectUris || ["".concat(baseUrl, "/oauth/callback")],
    ...
    jwks_uri: config.jwksUri || "".concat(baseUrl, "/oauth/jwks.json"),
...
function initializeOAuth() {
  return _initializeOAuth.apply(this, arguments);
}
function _initializeOAuth() {
  _initializeOAuth = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var config,
      stores,
      requiredEnvVars,
      _args = arguments;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          stores = _args.length > 1 && _args[1] !== undefined ? _args[1] : {};
          requiredEnvVars = ['OAUTH_JWT_SECRET', 'OAUTH_PRIVATE_KEY_1', 'OAUTH_PRIVATE_KEY_2', 'OAUTH_PRIVATE_KEY_3'];
          ...
          _context.t0 = NodeOAuthClient;
          _context.t1 = getConfig(config);
          _context.next = 10;
          return Promise.all([JoseKey.fromImportable(process.env.OAUTH_PRIVATE_KEY_1, 'key1'), JoseKey.fromImportable(process.env.OAUTH_PRIVATE_KEY_2, 'key2'), JoseKey.fromImportable(process.env.OAUTH_PRIVATE_KEY_3, 'key3')]);
        case 10:
          _context.t2 = _context.sent;
          _context.t3 = stateStore;
          _context.t4 = sessionStore;
          _context.t5 = {
            clientMetadata: _context.t1,
            keyset: _context.t2,
            stateStore: _context.t3,
            sessionStore: _context.t4
          };
          client = new _context.t0(_context.t5);
...
module.exports = {
  ...
  getStateStore: function getStateStore() {
    return stateStore;
  },
