...
import _routesJs from "./routes.mjs";
...
var _require = _oauthJs,
  initializeOAuth = _require.initializeOAuth,
  getClient = _require.getClient,
  getSessionStore = _require.getSessionStore,
  getStateStore = _require.getStateStore;
var _require2 = _sessionStoreJs,
  InMemoryStore = _require2.InMemoryStore;
var _require3 = _middlewareJs,
  authenticateToken = _require3.authenticateToken;
var _require4 = _routesJs,
  setupOauthRoutes = _require4.setupOauthRoutes;
function setupExpressAuth(_x) {
  return _setupExpressAuth.apply(this, arguments);
}
function _setupExpressAuth() {
  _setupExpressAuth = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(app) {
    var options,
      _yield$initializeOAut,
      client,
      sessionStore,
      stateStore,
      _args = arguments;
...
module.exports = {
  setupExpressAuth: setupExpressAuth,
